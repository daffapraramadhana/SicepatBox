...
export default class FormProvinsi2 extends Component {
  ...
  getOptions() {
    axios({
      method: "POST",
      url: "http://192.168.7.118:3005/service/list-provinsi",
      data: {},
    }).then((res) => {
  ...
  handleChange(a) {
    ...
    axios({
      method: "POST",
      url: "http://192.168.7.118:3005/service/list-kabupaten",
      data: {
        province: a.value,
      },
    }).then((res) => {
  ...
  handleChangeKabupaten(b) {
    ...
    axios({
      method: "POST",
      url: "http://192.168.7.118:3005/service/list-kecamatan",
      data: {
  ...
  handleChangeKecamatan(c) {
    ...
    axios({
      method: "POST",
      url: "http://192.168.7.118:3005/service/list-kelurahan",
      data: {
        province: this.state.provinsi,
